...
* - File operations: create, open, read, write, lseek, truncate, rm, stat
*
* Notes :
* - Data is stored only in RAM (no hard disk usage)
* - Boot block is not used as OS is already running
